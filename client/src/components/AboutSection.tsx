...
function AnimatedCounter({ value, suffix = '', className = '' }: AnimatedCounterProps) {
  ...
  useEffect(() => {
    // Subscriber to update the text content directly for performance
    const unsubscribe = springValue.on("change", (latest) => {
      if (ref.current) {
        // Format number with commas if needed, though usually stats are short
        // We use Math.floor to keep it integer-like during animation if desired, 
        // or just let it be smooth. Rounding is usually best for counts.
...
function AboutHeader() {
  ...
  return (
    ...
    >
      ...
      <h2 className="font-outfit text-4xl sm:text-5xl lg:text-6xl font-bold mb-8 leading-tight">
            ...
            >
              <Card className="value-card glass border border-white/10 h-full relative overflow-hidden group">
                ...
                <CardContent className="p-8 text-center relative z-10">
                  <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${value.gradient} p-3 relative overflow-hidden group-hover:scale-110 transition-transform duration-300`}>
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-purple-500 via-pink-500 to-cyan-500 rounded-full h-full">
          {isInView && <div className="w-full h-full timeline-line animate" />}
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 lg:w-5/12">
                  <div className={`${index % 2 === 0 ? 'lg:text-right lg:pr-16' : 'lg:text-left lg:pl-16'}`}>
                    <motion.div
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="text-5xl font-bold bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent mb-2 inline-flex items-center justify-center">
                  ...
                  <div className="p-6 w-full">
                    ...
                    <div className="flex space-x-3">
                      <button
                        ...
                        className="w-8 h-8 glass rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-colors duration-300"
                      >
...
export function AboutSection() {
  ...
  return (
    <section id="about" ref={containerRef} className="py-20 relative overflow-hidden min-h-screen">
      ...
      <motion.div
        style={{ y: y1 }}
        className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-3xl opacity-60"
      />
      <motion.div
        style={{ y: y2 }}
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-full blur-3xl opacity-60"
      />
