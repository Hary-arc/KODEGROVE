              ...
              return (
                ...
                <Card className="value-card glass border border-white/10 h-full relative overflow-hidden group">
                  ...
                  <CardContent className="p-8 text-center relative z-10">
                    ...
                    <h4 className="font-outfit text-xl font-bold text-white mb-4">{value.title}</h4>
                      ...
                      >
                        ...
                        <div className="relative z-10">
                          <div className="flex items-center space-x-3 mb-4">
                            ...
                            <h4 className="font-outfit text-2xl font-bold text-white">{item.title}</h4>
                          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Let's collaborate to transform your vision into a mesmerizing digital reality 
              that captivates users and drives unprecedented growth.
            </p>
