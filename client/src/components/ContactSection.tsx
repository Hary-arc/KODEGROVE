                ...
                {!isSubmitted ? (
                  <>
                    <div className="mb-8">
                      ...
                      <p className="text-gray-300">Tell us about your vision and we'll make it mesmerizing.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="w-full h-12 px-3 glass border border-white/20 rounded-lg focus:border-cyan-400 text-white bg-transparent"
                        >
                          <option value="" className="bg-slate-900">When do you need this completed?</option>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="message" className="text-white font-medium">Project Vision *</Label>
                        <Textarea
                          id="message"
                          name="message"
                          required
                  ...
                  >
                    ...
                    <p className="text-xl text-gray-300 mb-6">
                      Your message has been sent. We'll get back to you within 2 hours with some digital magic.
                    </p>
