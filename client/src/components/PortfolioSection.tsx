...
import { SitePreviewModal } from "./PreviewPage";
import {
  ExternalLink,
  ArrowUpRight,
  X,
...
export function PortfolioSection() {
  ...
  const handleLivePreview = (project: any) => {
    if (project.demoLink) {
      setPreviewUrl(project.demoLink);
      setPreviewTitle(project.title);
      setPreviewCategory(project.category);
    }
  };
                            ...
                            <div className="flex flex-wrap gap-3 justify-center px-4">
                              ...
                              {/* {project.demoLink && (
                                <Button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleLivePreview(project);
                                  }}
                                  className="gradient-electric text-white backdrop-blur-xl shadow-2xl hover:shadow-purple-500/50"
                                  size="lg"
                                >
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex flex-col space-y-3">
                        <Button
                          ...
                          className="gradient-electric text-white w-full"
                        >
                        ...
                        {selectedProjectData.demoLink && (
                          <Button
                            ...
                            onClick={() => {
                              setSelectedProject(null);
                              handleLivePreview(selectedProjectData);
                            }}
                            variant="outline"
                            className="glass border-white/20 text-white hover:bg-white/10 w-full"
                          >
