...
const getProjectGradient = (category: string, id: number) => {
  const gradients = {
    Featured: id % 2 === 1 ? 'from-purple-500 to-pink-500' : 'from-blue-500 to-cyan-500',
    B2B: id % 2 === 1 ? 'from-green-500 to-emerald-500' : 'from-orange-500 to-red-500',
    B2C: id % 2 === 1 ? 'from-pink-500 to-rose-500' : 'from-cyan-500 to-blue-500',
    eCommerce: id % 2 === 1 ? 'from-purple-500 to-indigo-500' : 'from-yellow-500 to-orange-500',
  };
  return gradients[category as keyof typeof gradients] || gradients.Featured;
};
...
const convertProjectData = (project: any) => ({
  ...
  results: [
    ...
    {
      metric: project.client ? project.client.split(' ')[0] : 'Client',
      label: 'Client',
    },
  ],
});
...
export function PortfolioSection() {
  ...
  const filteredProjects = convertedProjects.filter(project => {
    const matchesTab = activeTab === 'Featured' ? project.featured : project.category === activeTab;
    const matchesSearch =
      searchTerm === '' ||
  ...
  const selectedProjectData = convertedProjects.find(p => p.id === selectedProject);

  const selectedCaseStudyData = convertedProjects.find(p => p.id === selectedCaseStudy);
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10" ref={ref}>
          ...
          >
            ...
            >
              ...
              <span className="font-medium text-gray-200">{pageHeaders.portfolio.badge}</span>
            </motion.div>
                    ...
                    <Card className="group cursor-pointer overflow-hidden glass border border-white/10 hover:border-white/30 transition-all duration-700 h-full relative hover-glow">
                      ...
                      <CardContent className="p-8">
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-6">
                          {project.results.map((result: any, resultIndex: number) => (
                            <motion.div
                              key={resultIndex}
            ...
            <div className="relative z-10">
              <h3 className="font-outfit text-4xl font-bold text-white mb-6">
                ...
                <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
                  Your {ctaContent.portfolio.title.split(' Your ')[1]}
                </span>
              </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                ...
                >
                  <span className="relative z-10 flex items-center space-x-3">
                    ...
                    <span>{ctaContent.portfolio.primaryButton}</span>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-white">
                            {selectedProjectData.client || 'Confidential'}
                          </p>
                        </div>
                        <div>
                          <h5 className="text-sm font-medium text-gray-400 mb-1">Year</h5>
                          <p className="text-white">{selectedProjectData.year}</p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {selectedProjectData.results.map((result: any, resultIndex: number) => (
                            <motion.div
                              key={resultIndex}
                              className="text-center p-3 glass rounded-xl border border-white/10"
                              whileHover={{ scale: 1.05 }}
