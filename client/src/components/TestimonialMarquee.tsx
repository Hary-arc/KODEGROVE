...
export function TestimonialMarquee({ featuredTestimonials = testimonials.slice(0, 6) }) {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="font-medium text-gray-200">Client Love</span>
          </motion.div>
        ...
        >
          <div className="animate-marquee-rtl flex gap-6" style={{ animationDuration: '60s' }}>
            {[...featuredTestimonials, ...featuredTestimonials, ...featuredTestimonials].map(
              (testimonial, index) => (
                <div
                      ...
                      <div className="space-y-5 text-sm text-white/90">
                        ...
                        <div className="flex items-center justify-between gap-4 border-b border-white/10 pb-2">
                          ...
                          <span className="font-semibold text-cyan-400">
                            {testimonial.metrics?.time || '2–3 weeks'}
                          </span>
                        </div>
                        ...
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <span className="font-semibold text-purple-400">
                            {testimonial.metrics?.engagement || '+250%'}
                          </span>
                        </div>
                      </div>
                    </div>
