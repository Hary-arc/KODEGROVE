...
export function WebsiteCalculator({ isOpen, onClose }: WebsiteCalculatorProps) {
  ...
  const getSelectedFeatures = () => {
    return calculatorFeatures.filter(feature => selectedFeatures.includes(feature.id));
  };
                          ...
                          {[
                            {
                              id: 'standard',
                              name: 'Standard',
                              desc: 'Clean, professional website',
                              multiplier: '1x',
                            },
                            {
                              id: 'premium',
                              name: 'Premium',
                              desc: 'Advanced features & design',
                              multiplier: '1.3x',
                            },
                            {
                              id: 'enterprise',
                              name: 'Enterprise',
                              desc: 'Custom solutions & integrations',
                              multiplier: '1.6x',
                            },
                          ].map(type => (
                            <motion.button
                        ...
                        <div className="glass rounded-xl p-6 border border-white/10">
                          <div className="flex items-center justify-between mb-4">
                            <span className="text-gray-300">
                              Desired Timeline: {timeline[0]} weeks
                            </span>
                            <span
                              className={`font-semibold ${timeline[0] <= 3 ? 'text-orange-400' : 'text-green-400'}`}
                            >
                              {timeline[0] <= 2
                                ? '+50%'
                                : timeline[0] <= 3
                            ...
                            return (
                              <div key={category}>
                                <div className="flex items-center space-x-2 mb-3">
                                  <div
                                    className={`w-8 h-8 rounded-lg bg-gradient-to-r ${categoryColor} flex items-center justify-center`}
                                  >
                      ...
                      <div className="glass rounded-xl p-6 border border-white/10 sticky top-4">
                        ...
                        <div className="space-y-3 mb-6">
                          ...
                          {pages[0] > 5 && (
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">
                                Additional Pages ({pages[0] - 5})
                              </span>
                              <span className="text-white">
                                ${(pages[0] - 5) * basePricePerPage}
                              </span>
                            </div>
                          )}
                          ...
                          {projectType !== 'standard' && (
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-400">
                                {projectType.charAt(0).toUpperCase() + projectType.slice(1)} Upgrade
                              </span>
                              <span className="text-purple-400">
                                ×{projectType === 'premium' ? '1.3' : '1.6'}
                              </span>
                            </div>
                          )}
                        ...
                        <div className="space-y-3">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              window.location.href = `#/contact?quote=${encodeURIComponent(
                                JSON.stringify({
                                  pages: pages[0],
