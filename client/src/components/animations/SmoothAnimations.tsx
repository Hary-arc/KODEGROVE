...
export const OrganicButton = ({
  ...
  const variants = {
    primary: "bg-gradient-to-r from-purple-600 via-violet-600 to-purple-700 text-white shadow-lg shadow-purple-500/25",
    secondary: "bg-gradient-to-r from-slate-700 to-slate-800 text-white border border-purple-500/30",
