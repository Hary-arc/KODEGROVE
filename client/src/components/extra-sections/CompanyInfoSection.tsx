      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Get to know the company behind your success. From our humble beginnings to our global
            presence, we believe in complete transparency with our clients and partners.
          </p>
        </motion.div>
        ...
        <ResponsiveCardGrid columns={3} gap="md" className="mb-16 lg:mb-20">
          {companyFacts.map((fact, index) => (
            ...
            >
              ...
              <div className="font-semibold text-gray-200 mb-1">{fact.label}</div>
              <div className="text-sm text-gray-400">{fact.description}</div>
            </ResponsiveCard>
          ))}
        </ResponsiveCardGrid>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`w-full lg:w-5/12 ${isEven ? 'lg:pr-8' : 'lg:pl-8'}`}>
                        <ResponsiveCard variant="glass" size="md" hover={true} className="group">
                          <div className="flex items-start space-x-4">
                            <div
                              className={`w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br ${milestone.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-500 flex-shrink-0`}
                            >
              ...
              {offices.map((office, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-xs text-gray-500">Timezone: {office.timezone}</div>
                    <Button
                      variant="outline"
                      size="sm"
            ...
            {legalDocs.map((doc, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-3">{doc.description}</p>
