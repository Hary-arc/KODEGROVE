...
const creativeSolutions = [
  {
    ...
    description:
      'Stunning, user-centric designs that not only look incredible but convert visitors into customers.',
    icon: Target,
  ...
  },
  {
    ...
    description:
      'Data-driven marketing strategies that amplify your brand reach and drive sustainable business growth.',
    icon: TrendingUp,
  ...
  },
  {
    ...
    description:
      'Comprehensive brand identity solutions that resonate with your audience and build lasting connections.',
    icon: Users,
...
export function CreativeSolutionsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-24 lg:py-32 relative overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950/30 to-slate-950"
    >
      {/* Background Elements */}
          ...
          <div className="space-y-8">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                and digital marketing solutions to generate greater brand engagement and
                conversions.
              </p>

              <p className="text-base text-gray-400 leading-relaxed">
                We work closely with our clients to ensure each project meets their brand guidelines
                and business goals and to provide technical and marketing expertise to ensure
                optimal results.
              </p>
            </motion.div>
          </div>
                  ...
                  >
                    ...
                    >
                      <div className="relative h-full">
                        <div
                          className={`w-full h-full bg-gradient-to-br ${item.gradient} opacity-80`}
                        />
