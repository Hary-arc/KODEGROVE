              ...
              return (
                ...
                >
                  <div className="relative">
                    <div
                      className={`w-16 h-16 mb-4 rounded-2xl bg-gradient-to-br ${measure.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}
                    >
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${getBadgeColor(cert.badge)} flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}
                      >
                        <Icon className="w-6 h-6 text-white" />
                      </div>
                      <div className="text-right">
                        <Badge
                          className={`bg-gradient-to-r ${getBadgeColor(cert.badge)} text-white border-0 text-xs mb-1`}
                        >
                          {cert.status}
                        </Badge>
                        <div className="text-xs text-gray-400">Valid: {cert.validUntil}</div>
                      </div>
                    </div>
              ...
              {auditDocs.map((doc, index) => (
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400 mb-3 leading-relaxed">{doc.description}</p>
        ...
        >
          <ResponsiveCard variant="gradient" size="full" className="text-center">
            ...
            <p className="text-lg text-gray-200 mb-6 max-w-2xl mx-auto">
              Ready to secure your digital assets with our proven security framework? Contact our
              security team for a custom security assessment.
            </p>
