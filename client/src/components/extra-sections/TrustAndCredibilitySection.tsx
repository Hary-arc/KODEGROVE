...
const trustTestimonials = [
  {
    quote: "CodeFlow transformed our business with their exceptional development skills and unwavering commitment to quality.",
  ...
  {
    quote: "The team's professionalism and technical expertise exceeded our expectations. Highly recommended!",
    author: "Michael Chen",
  ...
  {
    quote: "Outstanding service, on-time delivery, and excellent post-launch support. CodeFlow is our go-to development partner.",
...
const guarantees = [
  ...
  },
  {
    ...
    description: "We guarantee project delivery on schedule or provide compensation for delays caused by us.",
    period: "Always"
  },
  {
    icon: Zap,
...
export function TrustAndCredibilitySection({ showAll = true, variant = 'full' }: TrustAndCredibilitySectionProps) {
  if (variant === 'minimal') {
    return (
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {trustIndicators.map((indicator, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 rounded-2xl bg-gradient-to-br ${indicator.gradient} flex items-center justify-center`}>
        ...
        <ResponsiveCardGrid columns={4} gap="lg" className="mb-16 lg:mb-20">
          {trustIndicators.map((indicator, index) => {
            ...
            return (
              ...
              >
                <div className={`w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 rounded-2xl bg-gradient-to-br ${indicator.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}>
