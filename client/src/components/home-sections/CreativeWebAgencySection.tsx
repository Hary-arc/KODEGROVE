...
export default function CreativeWebAgencySection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-cyan-500/10 rounded-full blur-3xl animate-float"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            We're not just another web agency. We're digital artists and technical innovators who
            craft mesmerizing experiences that transform businesses and captivate audiences
            worldwide.
          </p>
        </motion.div>
...
function TimelineStep({
  ...
  return (
    <div className="flex-shrink-0 w-64 text-center cursor-default select-none">
      <div
        className="w-20 h-20 mx-auto rounded-full bg-gradient-to-r from-purple-500 to-cyan-500
