...
export default function CustomWebDesignPricingSection() {
  ...
  return (
    <section ref={sectionRef} className="py-24 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-float"
        ...
        >
          ...
          >
            <p className="text-lg text-gray-300 leading-relaxed">
              ...
              <span className="text-cyan-400 font-semibold">$30,000</span>, while more complex
              endeavors can reach <span className="text-cyan-400 font-semibold">$50,000</span> to{' '}
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              ...
              factor in determining cost. More complex setups that demand significant time and
              effort will naturally increase the overall price.
            </p>
          </motion.div>
