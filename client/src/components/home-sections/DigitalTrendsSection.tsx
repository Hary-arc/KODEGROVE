...
<div className="w-full sm:w-auto ">
  ...
  {/* Decorative numbers */}
  <div className="absolute -top-16 -left-16 text-[6rem] sm:text-[8rem] md:text-[10rem] font-bold opacity-10 select-none pointer-events-none">20</div>
  <div className="absolute -bottom-16 -right-16 text-[6rem] sm:text-[8rem] md:text-[10rem] font-bold opacity-10 select-none pointer-events-none">25</div>
</section>
