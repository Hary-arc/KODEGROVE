...
function ResponsiveCard({
  ...
  const variantClasses = {
    ...
    elevated:
      'bg-card text-card-foreground border border-border rounded-xl shadow-lg hover:shadow-xl',
    minimal: 'bg-transparent border-0 rounded-none',
    gradient:
      'bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-white/20 rounded-xl backdrop-blur-sm',
  };
...
function ResponsiveCardHeader({
  ...
  return <div className={cn('flex flex-col gap-1.5', responsiveClasses, className)} {...props} />;
}
...
function ResponsiveCardTitle({ className, size = 'md', ...props }: ResponsiveCardTitleProps) {
  const sizeClasses = {
  ...
  return (
    <h3 className={cn('font-semibold leading-tight', sizeClasses[size], className)} {...props} />
  );
}
...
function ResponsiveCardContent({
  ...
  return <div className={cn('flex-1', spacingClasses[spacing], className)} {...props} />;
}
...
function ResponsiveCardFooter({
  ...
  return (
    <div
      className={cn('mt-auto pt-3 sm:pt-4 lg:pt-6', directionClasses[direction], className)}
      {...props}
    />
  );
}
...
function ResponsiveCardGrid({
  ...
  return <div className={cn(gridClasses, gapClasses[gap], 'w-full', className)} {...props} />;
}
...
function AdaptiveCard({
  ...
  return (
    <ResponsiveCard className={cn(layoutClasses[layout], className)} {...props}>
      {children}
    </ResponsiveCard>
  );
}
