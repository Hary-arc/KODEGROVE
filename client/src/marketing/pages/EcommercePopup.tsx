...
import { ShoppingCart, CreditCard, BarChart3, Users, Zap, Shield, CheckCircle, ArrowRight, TrendingUp } from 'lucide-react'
    ...
    <div className="p-8">
      ...
      >
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
          Transform browsers into buyers with luxury e-commerce experiences that drive 
          ...
          {platforms.map((platform, index) => (
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <div className="mb-6">
                  <span className={`text-3xl font-bold bg-gradient-to-r ${platform.gradient} bg-clip-text text-transparent`}>
                    {platform.price}
                  </span>
                </div>
              </div>
          ...
          {successStories.map((story, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/10">
                ...
                <div className="text-center">
                  <div className="text-xl font-bold text-purple-400">{story.metrics.conversion}</div>
                  <div className="text-xs text-gray-400">Conversion</div>
                </div>
                <div className="text-center">
                  <div className="text-xl font-bold text-cyan-400">{story.metrics.traffic || story.metrics.retention}</div>
                  <div className="text-xs text-gray-400">{story.metrics.traffic ? 'Traffic' : 'Retention'}</div>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      >
        ...
        <p className="text-gray-300 mb-6 text-lg">
          Join successful businesses generating millions in online revenue with our e-commerce solutions.
        </p>
