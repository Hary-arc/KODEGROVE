            ...
            {[
              ...
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 bg-gradient-to-r ${contact.gradient} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
                    ...
                    {!isSubmitted ? (
                      ...
                      >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                          ...
                          <p className="text-sm text-gray-400 text-center">
                            🔒 Your information is secure and will never be shared. We respect your
                            privacy.
                          </p>
                        </form>
                      </motion.div>
                      ...
                      >
                        ...
                        <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                          Your message has been sent successfully. We'll get back to you within 2
                          hours with some extraordinary digital magic tailored just for you.
                        </p>
