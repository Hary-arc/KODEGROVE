  ...
  const platforms = [
    {
      ...
      features: ["SwiftUI Framework", "App Store Optimization", "Push Notifications", "In-App Purchases"],
  ...
  const process = [
    {
      ...
      description: "We analyze your business goals and target audience to create the perfect app strategy.",
      duration: "1-2 weeks"
    },
    {
      step: "02", 
    ...
    <div className="p-8">
      ...
      >
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8">
          Create mobile experiences that keep users engaged with fluid animations, 
