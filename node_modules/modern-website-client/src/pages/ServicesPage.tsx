      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden" ref={heroRef}>
        ...
        <div className="relative z-10 w-full pt-32">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              From concept to launch, we provide comprehensive digital solutions that 
              captivate audiences and accelerate business growth through innovative technology.
            </motion.p>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <h3 className="font-outfit text-2xl font-bold text-white mb-8">
              What We Deliver
            </h3>
            ...
            <div className="space-y-6">
              {service.features.map((feature: string, featureIndex: number) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${service.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  <Card className="overflow-hidden glass border border-white/10 hover:border-white/30 transition-all duration-700 hover-glow">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className={`text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r ${service.gradient}`}>
                          {caseStudy.metrics}
                        </div>
                      </div>
